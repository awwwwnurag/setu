...
const leftPanelGradient = 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)';
const rightPanelGradient = 'linear-gradient(135deg, #43cea2 0%, #185a9d 100%)';
...
export default function Login({ onAuth }) {
  ...
  return (
    <Box sx={{ minHeight: '100vh', width: '100vw', display: 'flex', alignItems: 'center', justifyContent: 'center', background: leftPanelGradient }}>
        ...
        <Box sx={{ flex: 1, background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 4 }}>
          <form onSubmit={handleSubmit} style={{ width: '100%' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, maxWidth: 320, mx: 'auto' }}>
              ...
              <Button type="submit" variant="contained" disabled={loading} sx={{ borderRadius: 3, fontWeight: 600, fontSize: '1.1rem', py: 1.2, background: rightPanelGradient }}>
