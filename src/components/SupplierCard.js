  ...
  return (
    <Paper
      ...
      sx={{
        ...
        boxShadow: '0 8px 32px 0 rgba(247, 151, 30, 0.15)',
        p: 3,
        m: 1,
        minWidth: 250,
        maxWidth: 320,
    ...
    >
      <Avatar sx={{ bgcolor: 'linear-gradient(135deg, #f7971e 0%, #ffd200 100%)', mb: 2, width: 56, height: 56, boxShadow: '0 2px 8px #f7971e55' }}>
